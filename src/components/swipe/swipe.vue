...
<template>
  <div class="rg-swipe">
    <div class="rg-swipe-items-wrap" ref="wrap">
      <slot></slot>
    </div>
    <div class="rg-swipe-indicators" v-show="showIndicators">
      <div
        class="rg-swipe-indicator"
...
<script>
import { once, addClass, removeClass } from "@/tools/utils/dom";
  ...
  methods: {
    ...
    rafTranslate(element, initOffset, offset, callback, nextElement) {
      ...
      function animationLoop() {
        ...
        if (nextElement) {
          nextElement.style.webkitTransform = `translate3d(${_offset -
            offset}px, 0, 0)`;
        }
