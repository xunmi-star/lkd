<template>
  ...
  >
    ...
    <div
      class="vux-cell-bd"
      :class="{'vux-cell-primary': primary === 'title' && valueAlign !== 'left'}"
    >
    ...
    <div class="weui-cell__ft" :class="valueClass">
      ...
      <icon name="arrow-right" v-if="isLink" style="width: 16px; height: 16px"></icon>
    </div>
...
export default {
  ...
  computed: {
    ...
    valueClass() {
      return {
        "vux-cell-primary":
          this.primary === "content" || this.valueAlign === "left",
...
@cell-disabled-arrow-color : #c8c8cd;
